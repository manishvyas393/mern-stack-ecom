...
export const adminNewProductAction = (form) => async (dispatch) => {
      try {
            ...
            const { data } = await Axios.post("/admin/product/new", form, config)
...
export const adminUpdateProductDetailAction = (id, userData) => async (dispatch) => {
      try {
            ...
            const { data } = await Axios.put(`/admin/updateproduct/details/${id}`, userData, config)
...
export const adminUpdateProductImagesAction = (id, images) => async (dispatch) => {
      try {
            ...
            const config = { headers: { "Content-Type": "multipart/form-data" } }
            const { data } = await Axios.put(`/admin/updateproduct/images/${id}`, images, config)
...
export const adminGetProductReviewAction = (id) => async (dispatch) => {
      try {
            ...
            const { data } = await Axios.get(`/getProductreviews?id=${id}`)
...
export const adminDeleteProductReviewAction = (productId,id) => async (dispatch) => {
      try {
            ...
            const { data } = await Axios.delete(`/deletereview?productId=${productId}&id=${id}`)
